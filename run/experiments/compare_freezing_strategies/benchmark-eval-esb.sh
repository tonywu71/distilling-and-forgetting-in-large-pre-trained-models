...
# python scripts/eval_whisper/eval_whisper_on_esb_librispeech.py checkpoints/finetuning/whisper_tiny-librispeech_clean_100h-benchmark-no_freeze/checkpoint-2500 >> $LOG 2> $ERR
...
# python scripts/eval_whisper/eval_whisper_on_esb_librispeech.py checkpoints/finetuning/whisper_tiny-librispeech_clean_100h-benchmark-freeze_decoder/checkpoint-3000 >> $LOG 2> $ERR
