...
# python scripts/gen_whisper_preds_with_timestamps.py tiny ami_test >> $LOG 2> $ERR
python scripts/gen_whisper_preds_with_timestamps.py medium ami_test >> $LOG 2> $ERR
