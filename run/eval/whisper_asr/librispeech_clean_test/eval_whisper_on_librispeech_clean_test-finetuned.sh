...
#! Name of the job:
#SBATCH -J eval_whisper_on_librispeech_clean_test-finetuned
...
python scripts/eval_whisper.py checkpoints/finetuning/whisper_tiny/librispeech_clean_100h/final --dataset-name librispeech_clean_test --all >> $LOG 2> $ERR
