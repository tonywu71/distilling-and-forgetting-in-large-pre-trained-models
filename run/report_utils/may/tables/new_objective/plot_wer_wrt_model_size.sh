python scripts/report_utils/wer_wrt_model_size/vanilla/plot_wer_wrt_model_size.py \
    outputs/report/wer_wrt_model_size/wer_wrt_model_size-esb_librispeech.csv \
    --savename vanilla/wer_wrt_model_size-esb_librispeech

python scripts/report_utils/wer_wrt_model_size/vanilla/plot_wer_wrt_model_size.py \
    outputs/report/wer_wrt_model_size/wer_wrt_model_size-ami.csv \
    --plot-expected \
    --savename vanilla/wer_wrt_model_size-ami
