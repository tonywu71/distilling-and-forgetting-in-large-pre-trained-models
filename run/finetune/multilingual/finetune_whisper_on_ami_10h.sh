...
#! Name of the job:
#SBATCH -J finetune_whisper_on_ami_10h
...
python scripts/finetune_whisper.py configs/finetune_configs/multilingual/ami_10h/finetune_tiny-ami_10h.yaml >> $LOG 2> $ERR
