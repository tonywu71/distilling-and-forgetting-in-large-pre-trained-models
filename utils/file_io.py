...
def extract_savepath_from_model_filepath(model_filepath: str) -> Path:
    ...
    Examples:
    - "test/checkpoints/whisper_small/librispeech_100h/checkpoint-200" -> "whisper_small/librispeech_100h/checkpoint-200"
    ...
    if CHECKPOINTS_DIRNAME in path.parts:  # if the path is a checkpoint...
        ...
        savepath = (DEFAULT_OUTPUT_DIR / path.name.replace(".", "-")).with_suffix(".csv")
